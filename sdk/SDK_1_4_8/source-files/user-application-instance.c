...
uint32_t* p_errno = (uint32_t*)(0x200080ec);

uint32_t* p_errline = (uint32_t*)(0x20008010);

uint32_t* p_dbg_uci = (uint32_t*)(0x200080f0);
 ...
 */
const ErrnoVal (*sleep)(uint32_t time, uint16_t pin, uint8_t pinEdge) = (void*)(0x00204d39);
 ...
 * @return errnoVal (ErrnoVal) .
 */
const ErrnoVal (*deepSleep)(uint16_t pin) = (void*)(0x00204d45);
 ...
 * @return errnoVal (ErrnoVal) .
 */
const ErrnoVal (*limitCurrent)(uint8_t milliAmps) = (void*)(0x00204d51);
 ...
 */
const uint32_t (*persistentRead)(void) = (void*)(0x00204d85);
 ...
 */
const void (*persistentWrite)(uint32_t value) = (void*)(0x00204d89);
 ...
 * @return errnoVal (ErrnoVal) .
 */
const ErrnoVal (*pinMode)(uint16_t pinMask, uint8_t mode) = (void*)(0x00202661);
 ...
 * @return errnoVal (ErrnoVal) .
 */
const ErrnoVal (*digitalWrite)(uint16_t pinMask, uint8_t value) = (void*)(0x002027ad);
 ...
 */
const uint8_t (*digitalRead)(uint16_t pinMask) = (void*)(0x0020280d);
 ...
 */
const int32_t (*analogRead)(uint8_t channel) = (void*)(0x00202851);
 ...
 */
const uint32_t (*millis)(void) = (void*)(0x002043ed);
 ...
 */
const uint32_t (*micros)(void) = (void*)(0x00204269);
 ...
 */
const uint64_t* (*micros64)(void) = (void*)(0x00204319);
 ...
 */
const uint64_t* (*ticks)(void) = (void*)(0x00204e4d);
 ...
 */
const void (*delay)(uint32_t timeMs) = (void*)(0x0020442b);
 ...
 */
const void (*delayMicroseconds)(uint32_t time) = (void*)(0x00204403);
 ...
 */
const int32_t (*getXtalPpb)(int32_t adc_ext_temperature) = (void*)(0x00204541);
 ...
 * @return errnoVal (ErrnoVal) .
 */
  .atMicroseconds = (void*)(0x00203ef9),
...
function must take no parameters and return nothing.
 */
  .everyMicroseconds = (void*)(0x00204019),
 ...
 * @return errnoVal (ErrnoVal) .
 */
const ErrnoVal (*attachInterrupt)(uint16_t source, void (*isr)(void), int8_t mode) = (void*)(0x00202c75);
 ...
 * @return errnoVal (ErrnoVal) .
 */
const ErrnoVal (*detachInterrupt)(uint16_t source) = (void*)(0x00202f05);
 ...
 */
const uint32_t (*noInterrupts)(void) = (void*)(0x00202b25);
...
to interrupts() for reactivation.
 */
const uint32_t (*interrupts)(uint32_t counter) = (void*)(0x0020306d);
 ...
 */
const uint32_t (*waitForEvent)(uint32_t timeMs) = (void*)(0x002030e5);
...
[eventMask values]:
  ...
  EVENT_TIMEOUT          
 */
const void (*triggerEvent)(uint32_t eventMask) = (void*)(0x00202b51);
...
value is '0x0'.
 */
const void (*clearEvent)(uint32_t eventMask) = (void*)(0x00202b41);
 ...
 */
const uint32_t (*readEvents)(void) = (void*)(0x002030b9);
 ...
 */
  .beginTransaction = (void*)(0x002033e5),
...
to access it.
 */
  .endTransaction = (void*)(0x00203869),
 ...
 */
const uint32_t (*getRandom)(uint32_t min, uint32_t max) = (void*)(0x00203135);
 ...
 */
const void (*randomSeed)(uint32_t seed) = (void*)(0x00203159);
 ...
 */
const uint32_t (*usqrt)(uint32_t value) = (void*)(0x0020315d);
 ...
 */
const uint32_t (*getSerialNumber)(void) = (void*)(0x00203189);
 ...
 */
const uint32_t (*getCurrentCrc)(void) = (void*)(0x0020319d);
 ...
 */
const uint32_t (*getAntennaDelay)(void) = (void*)(0x002031c1);
 ...
 */
const uint32_t (*getHardwareId)(void) = (void*)(0x002031e5);
 ...
 * @return errnoVal (ErrnoVal) .
 */
  .configEncryption = (void*)(0x00202361),
 ...
 * @return errnoVal (ErrnoVal) .
 */
  .configDecryption = (void*)(0x0020247d),
