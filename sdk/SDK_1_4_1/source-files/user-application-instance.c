...
uint32_t* p_errno = (uint32_t*)(0x20008200);

uint32_t* p_errline = (uint32_t*)(0x20008018);

uint32_t* p_dbg_uci = (uint32_t*)(0x20008204);
...
rising edge.
 */
const void (*sleep)(uint32_t time, uint16_t pin, uint8_t pinEdge) = (void*)(0x00205d31);
...
returned.
 */
const void (*deepSleep)(uint16_t pin) = (void*)(0x00205d3d);
 ...
 */
const void (*limitCurrent)(uint8_t milliAmps) = (void*)(0x00205d47);
 ...
 */
const uint32_t (*persistentRead)(void) = (void*)(0x00205d49);
 ...
 */
const void (*persistentWrite)(uint32_t value) = (void*)(0x00205d4d);
...
[stack values]:
  USER_STACK             User thread, used for setup() and loop().
  IDLE_STACK             Idle thread, used in attachInterrupt(IDLE, foo, 0).
  INTERRUPT_STACK        Interrupt thread, used in attachInterrupt(other than IDLE, foo, 0) and UWB.on functions.
 *
 * @return byteCount (uint16_t) .
 */
const uint16_t (*stackCapacity)(uint8_t stack) = (void*)(0x0020326d);
 ...
 * @return byteCount (uint16_t) .
 */
const uint16_t (*stackUsageMax)(uint8_t stack) = (void*)(0x002032b1);
 ...
 * @return byteCount (uint16_t) .
 */
const uint16_t (*stackUsageCurrent)(uint8_t stack) = (void*)(0x00203309);
 ...
 * @return byteCount (uint16_t) .
 */
const uint16_t (*globalsCapacity)(void) = (void*)(0x0020335d);
 ...
 * @return byteCount (uint16_t) .
 */
const uint16_t (*globalsUsage)(void) = (void*)(0x00203363);
 ...
 */
const void (*pinMode)(uint16_t pinMask, uint8_t mode) = (void*)(0x0020371d);
...
[value values]:
  ...
  HIGH                   Logical 1.
 */
const void (*digitalWrite)(uint16_t pinMask, uint8_t value) = (void*)(0x00203865);
 ...
 */
const uint8_t (*digitalRead)(uint16_t pinMask) = (void*)(0x002038bd);
 ...
 */
const int32_t (*analogRead)(uint8_t channel) = (void*)(0x00203901);
 ...
 */
const uint32_t (*millis)(void) = (void*)(0x00205479);
 ...
 */
const uint32_t (*micros)(void) = (void*)(0x002052f5);
 ...
 */
const uint64_t* (*micros64)(void) = (void*)(0x002053a5);
 ...
 */
const uint64_t* (*ticks)(void) = (void*)(0x00205e11);
 ...
 */
const void (*delay)(uint32_t timeMs) = (void*)(0x00205491);
 ...
 */
const void (*delayMicroseconds)(uint32_t time) = (void*)(0x002054f1);
 ...
 */
const int32_t (*getXtalPpb)(int32_t adc_ext_temperature) = (void*)(0x00201bb5);
...
function must take no parameters and return nothing.
 */
  .atMicroseconds = (void*)(0x00204f7d),
...
function must take no parameters and return nothing.
 */
  .everyMicroseconds = (void*)(0x002050a1),
...
[source values]:
  ...
  UWB_TX_DONE            Triggers when TX has completed.
  UWB_RX_SFD             Triggers when the Start of Frame Delimiter (SFD) is received. THE SFD is positioned between the SYNC (preamble) part and the PHR part. The SFD part is used for time-stamping which is useful for ranging.
  UWB_RX_PHR             Triggers when the PHR is received. PHR stands for Physical Layer Header. It provides information to the receiver about the transmitted payload and other useful physical layer information.
  UWB_RX_START           Triggers when RX has started.
  UWB_RX_EOF             Triggers when the End of Frame (EOF) is detected.
  UWB_VBUF_LOW           Triggers when the the voltage of VBUF is too low. Adjust current limiter or add capacitance to resolve this.
  IDLE                   Triggers when the main thread is idle (i.e. during a waitForEvent()).
 ...
 * @param mode (int16_t) Defines when the interrupt should be triggered. For example on the 
 ...
 */
const void (*attachInterrupt)(uint16_t source, void (*isr)(void), int16_t mode) = (void*)(0x00203d21);
 ...
 */
const void (*detachInterrupt)(uint16_t source) = (void*)(0x00203fb9);
 ...
 */
const uint32_t (*noInterrupts)(void) = (void*)(0x00203bd5);
...
to interrupts() for reactivation.
 */
const uint32_t (*interrupts)(uint32_t counter) = (void*)(0x00204119);
 ...
 */
const uint32_t (*waitForEvent)(uint32_t timeMs) = (void*)(0x00204181);
...
[eventMask values]:
  ...
  EVENT_TIMEOUT          
 */
const void (*triggerEvent)(uint32_t eventMask) = (void*)(0x00203c01);
...
value is '0x0'.
 */
const void (*clearEvent)(uint32_t eventMask) = (void*)(0x00203bf1);
 ...
 */
const uint32_t (*readEvents)(void) = (void*)(0x00204165);
 ...
 */
  .beginTransaction = (void*)(0x00204459),
...
to access it.
 */
  .endTransaction = (void*)(0x002048e1),
 ...
 */
const uint32_t (*getRandom)(uint32_t min, uint32_t max) = (void*)(0x002041a1);
 ...
 */
const void (*randomSeed)(uint32_t seed) = (void*)(0x002041c5);
 ...
 */
const uint32_t (*usqrt)(uint32_t value) = (void*)(0x002041c9);
 ...
 */
const uint32_t (*getSerialNumber)(void) = (void*)(0x002041f5);
 ...
 */
const uint32_t (*getCurrentCrc)(void) = (void*)(0x00204209);
 ...
 */
const uint32_t (*getAntennaDelay)(void) = (void*)(0x0020422d);
 ...
 */
const uint32_t (*getHardwareId)(void) = (void*)(0x00204251);
 ...
 */
  .configEncryption = (void*)(0x00203415),
 ...
 * @param aadLength (uint8_t) Length of the provided AAD value (number of bytes).
 */
  .configDecryption = (void*)(0x00203535),
