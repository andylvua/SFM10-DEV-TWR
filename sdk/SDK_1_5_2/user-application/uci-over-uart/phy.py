...
ACTIONS_IS_BUSY = 0x02
ACTIONS_IS_BUSY_SIZE = 0
...
ACTIONS_READ_TX_TIME = 0x11
ACTIONS_READ_TX_TIME_SIZE = 0

ACTIONS_READ_RX_TIME = 0x12
ACTIONS_READ_RX_TIME_SIZE = 0

ACTIONS_READ_LOOPBACK_TIME = 0x13
ACTIONS_READ_LOOPBACK_TIME_SIZE = 0

ACTIONS_READ_PAYLOAD = 0x15
ACTIONS_READ_PAYLOAD_SIZE = 0

ACTIONS_READ_FIRST_PATH_INFO = 0x16
ACTIONS_READ_FIRST_PATH_INFO_SIZE = 0

ACTIONS_READ_CIR = 0x17
ACTIONS_READ_CIR_SIZE = 3
...
byte1_actions = dict([
  ...
  (ACTIONS_READ_TX_TIME, "read tx time"),
  (ACTIONS_READ_RX_TIME, "read rx time"),
  (ACTIONS_READ_LOOPBACK_TIME, "read loopback time"),
  (ACTIONS_READ_PAYLOAD, "read payload"),
  (ACTIONS_READ_FIRST_PATH_INFO, "read first path info"),
  (ACTIONS_READ_CIR, "read cir"),
