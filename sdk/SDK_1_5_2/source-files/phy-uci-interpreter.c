...
/**_____________________________|           Actions            |_____________________________**/
    case UCI_ACTIONS: {
      switch (UCI_OID(input)) {
        ...
        case UCI_ACTIONS_IS_BUSY: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_IS_BUSY, sizeof(IsBusyRsp));
          retCode = UWB.isBusy();
        } break;
        ...
        case UCI_ACTIONS_READ_TX_TIME: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_READ_TX_TIME, sizeof(ReadTxTimeRsp));
          retCode = UWB.readTxTime(&(((ReadTxTimeRspPacket*)output)->payload));
        } break;
        case UCI_ACTIONS_READ_RX_TIME: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_READ_RX_TIME, sizeof(ReadRxTimeRsp));
          retCode = UWB.readRxTime(&(((ReadRxTimeRspPacket*)output)->payload));
        } break;
        case UCI_ACTIONS_READ_LOOPBACK_TIME: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_READ_LOOPBACK_TIME, sizeof(ReadLoopbackTimeRsp));
          retCode = UWB.readLoopbackTime(&(((ReadLoopbackTimeRspPacket*)output)->payload));
        } break;
        case UCI_ACTIONS_READ_PAYLOAD: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_READ_PAYLOAD, sizeof(ReadPayloadRsp));
          retCode = UWB.readPayload(&(((ReadPayloadRspPacket*)output)->payload));
        } break;
        case UCI_ACTIONS_READ_FIRST_PATH_INFO: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_READ_FIRST_PATH_INFO, sizeof(ReadFirstPathInfoRsp));
          retCode = UWB.readFirstPathInfo(&(((ReadFirstPathInfoRspPacket*)output)->payload));
        } break;
        case UCI_ACTIONS_READ_CIR: {
          UCI_RSP_HEADER(output, UCI_ACTIONS, UCI_ACTIONS_READ_CIR, sizeof(ReadCirRsp));
          retCode = UWB.readCir(&(((ReadCirCmdPacket*)input)->payload), &(((ReadCirRspPacket*)output)->payload));
        } break;
