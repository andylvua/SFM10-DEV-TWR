...
#define PRIMARY_FLASH_SIZE     (0xEF00)
#define PRIMARY_RAM_START      (0x20008000)
#define PRIMARY_RAM_SIZE       (0x2000)

#define EEPROM_FLASH_START     (0x00201000 + 0xEF00)
#define EEPROM_FLASH_SIZE      (0x0100)
...
#define SECONDARY_RAM_SIZE (0x4000)

#define IRQ_STACK_SIZE  (0x600)
#define USER_STACK_SIZE  (0xC00)
