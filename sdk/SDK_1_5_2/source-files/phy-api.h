...
typedef enum __attribute__ ((__packed__)) UciActions { 
  ...
  /** @brief Returns not 0 when UWB action is being executed. */
  UCI_ACTIONS_IS_BUSY                                = 0x02,
  ...
  UCI_ACTIONS_READ_TX_TIME                           = 0x11,
    
  /** @brief To get the most recently captured (RX/TX) timestamp event. */
  UCI_ACTIONS_READ_RX_TIME                           = 0x12,
    
  /** @brief To get the most recently captured (RX/TX) timestamp event. */
  UCI_ACTIONS_READ_LOOPBACK_TIME                     = 0x13,
    
  /** @brief Returns the most recently received (RX) payload. */
  UCI_ACTIONS_READ_PAYLOAD                           = 0x15,
    
  /** @brief To get the most recently captured (RX) signal strength. */
  UCI_ACTIONS_READ_FIRST_PATH_INFO                   = 0x16,
    
  /** @brief Returns the most recent Channel Input Response (RX). */
  UCI_ACTIONS_READ_CIR                               = 0x17,
...
/**__________________________________________________________________________________________**/
/**_____________________________|           Is busy            |_____________________________**/

/** @brief Returns not 0 when UWB action is being executed. */

// OID = 0x02

#define IsBusyRsp GenericRsp

typedef struct __attribute__ ((__packed__))  IsBusyRspPacket {
  UciHeader header;
  IsBusyRsp payload;
} IsBusyRspPacket;

typedef struct __attribute__ ((__packed__))  IsBusyCmdPacket {
  UciHeader header;
...
/**__________________________________________________________________________________________**/
/**_____________________________|         Read tx time         |_____________________________**/
...
/** @brief To get the most recently captured (RX/TX) timestamp event. */
typedef struct __attribute__ ((__packed__)) ReadTxTimeRsp {
  /** @brief A generic UCI status code. The value of 0x00 indicates no error occurred.
   The attribute type is [enum]. */
  uint8_t uciStatus;
...
typedef struct __attribute__ ((__packed__))  ReadTxTimeRspPacket {
  UciHeader header;
  ReadTxTimeRsp payload;
} ReadTxTimeRspPacket;

typedef struct __attribute__ ((__packed__))  ReadTxTimeCmdPacket {
  UciHeader header;
...
/**__________________________________________________________________________________________**/
/**_____________________________|         Read rx time         |_____________________________**/
...
/** @brief To get the most recently captured (RX/TX) timestamp event. */
typedef struct __attribute__ ((__packed__)) ReadRxTimeRsp {
  /** @brief A generic UCI status code. The value of 0x00 indicates no error occurred.
   The attribute type is [enum]. */
  uint8_t uciStatus;
...
typedef struct __attribute__ ((__packed__))  ReadRxTimeRspPacket {
  UciHeader header;
  ReadRxTimeRsp payload;
} ReadRxTimeRspPacket;

typedef struct __attribute__ ((__packed__))  ReadRxTimeCmdPacket {
  UciHeader header;
...
/**__________________________________________________________________________________________**/
/**_____________________________|      Read loopback time      |_____________________________**/
...
/** @brief To get the most recently captured (RX/TX) timestamp event. */
typedef struct __attribute__ ((__packed__)) ReadLoopbackTimeRsp {
  /** @brief A generic UCI status code. The value of 0x00 indicates no error occurred.
   The attribute type is [enum]. */
  uint8_t uciStatus;
  /** @brief The captured Timestamp timer value for when the message is transmitted (TX). The 
...
typedef struct __attribute__ ((__packed__))  ReadLoopbackTimeRspPacket {
  UciHeader header;
  ReadLoopbackTimeRsp payload;
} ReadLoopbackTimeRspPacket;

typedef struct __attribute__ ((__packed__))  ReadLoopbackTimeCmdPacket {
  UciHeader header;
  
} ReadLoopbackTimeCmdPacket;


/**__________________________________________________________________________________________**/
/**_____________________________|         Read payload         |_____________________________**/
...
/** @brief Returns the most recently received (RX) payload. */
typedef struct __attribute__ ((__packed__)) ReadPayloadRsp {
  /** @brief A generic UCI status code. The value of 0x00 indicates no error occurred.
   The attribute type is [enum]. */
  uint8_t uciStatus;
  /** @brief The length of the payload (in bytes) stored in the payloadData buffer.
...
typedef struct __attribute__ ((__packed__))  ReadPayloadRspPacket {
  UciHeader header;
  ReadPayloadRsp payload;
} ReadPayloadRspPacket;

typedef struct __attribute__ ((__packed__))  ReadPayloadCmdPacket {
  UciHeader header;
  
} ReadPayloadCmdPacket;


/**__________________________________________________________________________________________**/
/**_____________________________|     Read first path info     |_____________________________**/
...
/** @brief To get the most recently captured (RX) signal strength. */
typedef struct __attribute__ ((__packed__)) ReadFirstPathInfoRsp {
  /** @brief A generic UCI status code. The value of 0x00 indicates no error occurred.
   The attribute type is [enum]. */
  uint8_t uciStatus;
...
} ReadFirstPathInfoRsp;


typedef struct __attribute__ ((__packed__))  ReadFirstPathInfoRspPacket {
  UciHeader header;
  ReadFirstPathInfoRsp payload;
} ReadFirstPathInfoRspPacket;

typedef struct __attribute__ ((__packed__))  ReadFirstPathInfoCmdPacket {
  UciHeader header;
  
} ReadFirstPathInfoCmdPacket;


/**__________________________________________________________________________________________**/
/**_____________________________|           Read cir           |_____________________________**/
...
/** @brief Returns the most recent Channel Input Response (RX). */
typedef struct __attribute__ ((__packed__)) ReadCirRsp {
  /** @brief A generic UCI status code. The value of 0x00 indicates no error occurred.
   The attribute type is [enum]. */
  uint8_t uciStatus;
...
/** @brief Returns the most recent Channel Input Response (RX). */
typedef struct __attribute__ ((__packed__)) ReadCirCmd {
  /** @brief Number of samples before the Timestamp pulse (First path index) to be included in 
  the CIR notification. 0 means the first sample is at the First path index.
   The attribute type is [int16]. Units are [samples]. The value(s) should be between -500 and 470. The default value is '-16'.  */
  int16_t channelImpulseResponseStart;
...
#define READCIRCMD_CHANNEL_IMPULSE_RESPONSE_START_DEFAULT -16
#define READCIRCMD_CHANNEL_IMPULSE_RESPONSE_LENGTH_DEFAULT 32

typedef struct __attribute__ ((__packed__))  ReadCirRspPacket {
  UciHeader header;
  ReadCirRsp payload;
} ReadCirRspPacket;

typedef struct __attribute__ ((__packed__))  ReadCirCmdPacket {
  UciHeader header;
  ReadCirCmd payload;
} ReadCirCmdPacket;
 ...
 * @param[out] uciStatus (enum uci status) A generic UCI status code. The value of 0x00 
indicates no error occurred.
 * @param[out] txTimestamp (uint64) The captured Timestamp timer value for when the message is 
transmitted (TX). The units are in ticks and to convert its value to seconds you have to 
multiply it by 1/(128*499.2e6). Units are [ticks].
 */
 ...
 * @param[out] uciStatus (enum uci status) A generic UCI status code. The value of 0x00 
indicates no error occurred.
 * @param[out] rxTimestamp (uint64) The captured Timestamp timer value for when the message is 
received (RX). The units are in ticks and to convert its value to seconds you have to multiply 
it by 1/(128*499.2e6). Units are [ticks].
 * @param[out] rxCarrierFreqOffset (int16) The device in Receive operation computes the 
frequency offset(CFO_INT) between transmitter and receiver carrier freq. This value will be 
provided after the Rx operation. To compute the ppm from this CFO_INT value, the following are 
the steps= A) Compute CFO in rad/pi per clock cycle= CFO = CFO_INT/2^17. B) Compute CFO(Hz) = 
(124.8MHz/2)*CFO. C) Compute CFO(ppm) = CFO(Hz) / (fc/1e6), where fc is the carrier frequency 
and for channel 9 it will be 7.9872GHz.
 */
 ...
 * @param[out] uciStatus (enum uci status) A generic UCI status code. The value of 0x00 
indicates no error occurred.
 * @param[out] payloadLength (uint16) The length of the payload (in bytes) stored in the 
payloadData buffer. Its value should be equal or smaller than 1020.
 * @param[out] payloadData (array) Payload data.
 */
 ...
 * @param[out] uciStatus (enum uci status) A generic UCI status code. The value of 0x00 
indicates no error occurred.
 * @param[out] firstPathDetected (uint32) Indicates the first path was detected and the ToA 
estimation results are valid. The first path detected status is indicated at the least 
significant bit position. i.e b_firstPathdetected = (bool) (firstPathdetected & 0x1).
 * @param[out] rfu1 (uint32) Reserved for future use.
 * @param[out] edgeIdx (uint32) Index of first crossing of the detection threshold.
 * @param[out] fpTime (int32) Interpolated ToA result (first path lead distance) in samples. 
ToA result = time / 2^15. The first path lead distance is the distance between the end of CIR 
and the estimated first path.
 * @param[out] maxTapIndex (uint16) Index of strongest path. Variable maxTapIndex is computed 
from simplified approximation in HW instead of complex CIR computation.
 * @param[out] maxTapPower (uint16) Power at the sample specified by maxTapIndex. Level[dBm] = 
(log10(2) * 10 * (float)(int16_t)maxTapPower) / 0x200.
 * @param[out] firstPathIndex (uint16) Index of first path.
 * @param[out] firstPathPower (int16) Power of the first path. The first-path power is measured 
at the first-path index found by the ToA algorithm. Level[dBm] = (log10(2) * 10 * 
(float)(int16_t)firstPathPower) / 0x200.
 * @param[out] noisePower (uint32) Noise power estimate. Level[dBm] = (log10(2) * 10 * 
(float)(int16_t)noisePower) / 0x2000000.
 * @param[out] detectThrPower (int32) Detection threshold power level. Level[dBm] = (log10(2) * 
10 * (float)(int16_t)detectThrPower) / 0x2000000.
 * @param[out] rfu2 (uint32) Reserved Fields.
 * @param[out] overallRxPower (int32) Overall received power computed by the Rx front end. 
Level[dBm] = (log10(2) * 10 * (float)overallRxPower) / 0x2000000.
 * @param[out] phr (uint32) Structure for the Physical Header (PHR) field of the UWB frame.
 */
